 ...
 */
// 1
var shopItemsArray = ["Bottle", "Sharp Stick", "Bandana"]
var shopItemsDictionary = ["Bottle": 5, "Sharp Stick": 10, "Bandana": 15, "Sword": 25]

// 2
shopItemsArray.contains("Sword")

// 3
shopItemsArray.insert("Sword", at: 1)
...
// 6
var fullArmorSet: Set = ["Chestplate", "Helmet", "Armguards", "Leg Braces"]
var currentArmorSet: Set = ["Armguards"]

// 7
fullArmorSet.subtract(currentArmorSet)

// 8
var armorPieceTuple = (name: "Crown of Thorns", cost: 1000, canEquip: true)
